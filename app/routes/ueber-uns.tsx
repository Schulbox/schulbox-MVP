  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <section className="space-y-6">
        <h2 className="text-2xl font-semibold text-gray-700">Unsere Vision</h2>
        ...
        <h2 className="text-2xl font-semibold text-gray-700">Unsere Mission</h2>
        <p className="text-lg text-gray-600">
        ...
        <h2 className="text-2xl font-semibold text-gray-700">Unsere Geschichte</h2>
        <p className="text-lg text-gray-600">
